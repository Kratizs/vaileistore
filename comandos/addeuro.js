...
if(typeof chatfinal === 'undefined') {
  ...
  fs.writeFile("./verify2/"+canal, data, (err) => {
    ...
    message.channel.send("Opa, irei avisar ali quando o euro sofrer alguma mudança")
  ...
  client.guilds.cache.get("822439547681243207").channels.cache.get("828450775054286889").send("O usuário: **<@" + message.author.id + ">** Adicionou 1 canal de euro \nServer: **" + message.guild.name + "**(" + message.guild.id + ") \nNome do chat: **#" + message.channel.name + "**(" + message.channel.id + ")")
})
}
}};